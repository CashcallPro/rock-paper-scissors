      ...
      <div className="z-10 flex flex-row sm:flex-row gap-y-2 sm:gap-x-3 pb-5 mb-12 sm:mb-6 px-16 w-full justify-between">
        {(['rock', 'paper', 'scissors'] as Choice[]).map((choice) => (
          <Button
            ...
            className="text-4xl sm:text-4xl md:text-4xl whitespace-pre-line bg-blue-400 hover:bg-blue-500 active:bg-blue-600 rounded-lg text-white m-5 p-4 w-16 h-16" // Added whitespace-pre-line for \n
